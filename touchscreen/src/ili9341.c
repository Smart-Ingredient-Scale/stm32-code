...
{
  ili9341_Init,
  ili9341_ReadID, // commented out
  ili9341_DisplayOn,
  ili9341_DisplayOff,
  ili9341_SetCursor,
  ili9341_WritePixel,
  ili9341_ReadPixel, // commented out
  ...
  ili9341_FillRect,
  ili9341_ReadRGBImage, // commented out
  ili9341_Scroll,
};
...
void ili9341_Init(void)
{
  ...
  LCD_IO_WriteCmd8(ILI9341_MADCTL); // TODO:
  LCD_IO_WriteData8(0x48);
