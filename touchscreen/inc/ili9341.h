...
uint16_t ili9341_ReadID(void); //commented out
...
uint16_t ili9341_ReadPixel(uint16_t Xpos, uint16_t Ypos); //commented out
...
void     ili9341_DrawBitmap(uint16_t Xpos, uint16_t Ypos, uint8_t *pbmp); //commented out
void     ili9341_DrawRGBImage(uint16_t Xpos, uint16_t Ypos, uint16_t Xsize, uint16_t Ysize, uint16_t *pData);
void     ili9341_ReadRGBImage(uint16_t Xpos, uint16_t Ypos, uint16_t Xsize, uint16_t Ysize, uint16_t *pData); //commented out
